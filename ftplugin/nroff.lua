...
keymap("n", "<F9>", ":sp<CR> :w<CR> :term groff -Tpdf % > %:r.pdf<CR> :q<CR>")
...
-- =============================================================================================================================
keymap("i", "<leader>dsu", '<cmd>lua require"getDate".getDate(weekdays.SUNDAY)<cr>') -- Sunday     = 1
keymap("i", "<leader>dmo", '<cmd>lua require"getDate".getDate(weekdays.MONDAY)<cr>') -- Monday     = 2
keymap("i", "<leader>dtu", '<cmd>lua require"getDate".getDate(weekdays.TUESDAY)<cr>') -- Tuesday    = 3
keymap("i", "<leader>dwe", '<cmd>lua require"getDate".getDate(weekdays.WEDNESDAY)<cr>') -- Wednesday  = 4
keymap("i", "<leader>dth", '<cmd>lua require"getDate".getDate(weekdays.THURSDAY)<cr>') -- Thursday   = 5
keymap("i", "<leader>dfr", '<cmd>lua require"getDate".getDate(weekdays.FRIDAY)<cr>') -- Friday     = 6
keymap("i", "<leader>dsa", '<cmd>lua require"getDate".getDate(weekdays.SATURDAY)<cr>') -- Saturday   = 7

-- Enter Publications Dates -- format example(Thursday, September 5, 2021)
-- ===========================================================================================================
keymap("i", "<leader>d", '<cmd>lua require"getPublicationDate".getPublicationDate()<cr>')
...
-- ==============================================================================================================
keymap("i", "<leader>n", "NS11L0201")
keymap("i", "<leader>b", "B8C0F0103")

-- Shortcut to calculate press report waste
-- ====================================================================================================================
keymap("i", "<leader>u", '<cmd>lua require"CalculateWaste".CalculateWaste()<cr>')

-- Shortcut to calculate roll waste
-- =============================================================================================================================
keymap("i", "<leader>w", '<cmd>lua require"CalculateRollWaste".CalculateRollWaste()<cr>')
